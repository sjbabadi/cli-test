class View {
  constructor() {
    ...
    this.events = {
      ...
      'toggle complete': function(handler) {
        //this.delegate('click', self.elements.table, 'td.list_item', handler);
  ...
  delegate(event, parentElement, childSelector, handler) {
    parentElement.addEventListener(event, (e) => {
      for(let tgt = e.target; tgt && tgt !== parentElement; tgt = tgt.parentNode) {
